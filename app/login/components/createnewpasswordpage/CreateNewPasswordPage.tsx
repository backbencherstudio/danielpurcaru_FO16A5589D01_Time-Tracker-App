...
const CreateNewPasswordPage = () => {
    ...
    return (
        ...
        <div id='CreateNewPasswordPage' className=' mx-auto  min-h-screen  w-full  px-5 py-6 md:px-10 md:py-8  lg:px-[100px] lg:py-[60px] flex flex-col justify-between  '>
            ...
            <div className='flex w-full flex-col gap-6 md:max-w-[485px]'>
                <div className='flex flex-col gap-4'>
                    <h1 className="text-neutral-800 text-3xl font-semibold font-['Urbanist'] leading-10">Create New Password</h1>
