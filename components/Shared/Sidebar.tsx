...
export default function Sidebar() {
    ...
    return (
        <div className="sm:px-4 px-2 h-full bg-white">
            <div className="space-y-3">
                ...
                <Link href="academic-calendar" className={`flex ${menu.academicCalender ? "text-white bg-[#82C8E5]" : "bg-white text-[#4A4C56]"} items-center lg:gap-[10px] px-[12px] py-2 rounded-lg cursor-pointer w-fit lg:w-full`} onClick={() => handleMenu("academicCalender")}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M2.5 6.91651C2.5 4.70737 4.29086 2.9165 6.5 2.9165H13.5C15.7091 2.9165 17.5 4.70737 17.5 6.9165V14.3332C17.5 16.5423 15.7091 18.3332 13.5 18.3332H6.5C4.29086 18.3332 2.5 16.5423 2.5 14.3332V6.91651Z" stroke="currentColor" strokeWidth="1.5" />
                        <path d="M2.5 7.5H17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                        <path d="M6.66667 1.6665L6.66667 4.1665" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <Link href="employee-loan" className={`flex ${menu.employeeLoan ? "text-white bg-[#82C8E5]" : "bg-white text-[#4A4C56]"} items-center lg:gap-[10px] px-[12px] py-2 rounded-lg cursor-pointer w-fit lg:w-full`} onClick={() => handleMenu("employeeLoan")}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
