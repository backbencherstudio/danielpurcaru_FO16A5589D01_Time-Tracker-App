...
export default function EmployeeHeader({ employee,handleMonthChange,selectedMonth }: { employee: Employee,handleMonthChange:(month:number)=>void,selectedMonth:number }) {
